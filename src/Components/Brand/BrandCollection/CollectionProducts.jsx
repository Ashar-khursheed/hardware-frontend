  ...
  return (
    <>
      {fetchStatus == "fetching" ? (
        ...
        <NoDataFound imageUrl={`/assets/svg/empty-items.svg`} customClass="no-data-added collection-no-data" title="no_product" description="no_product_desc" height={345} width={345} />
      )}
