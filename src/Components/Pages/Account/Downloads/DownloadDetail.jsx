    ...
    <Card className="dashboard-table mt-0">
      <CardBody className="p-0">
        ...
        <div className="download-detail dashboard-bg-box">
          <form>
            <InputGroup className="download-form">
              <Input placeholder={t("search_download")} onChange={(e) => setTerm(e.target.value)} />
        ...
        <div className="download-detail dashboard-bg-box p-0">
          ...
          {!data?.data?.length && <NoDataFound customClass="no-data-added" imageUrl={`/assets/svg/empty-items.svg`} title="no_item_found" description="no_order" height="300" width="300" />}
        </div>
      </CardBody>
    </Card>
  );
