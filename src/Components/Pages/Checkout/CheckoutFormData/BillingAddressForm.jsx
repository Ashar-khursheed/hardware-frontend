  ...
  return (
    <div className="checkbox-main-box">
      ...
      <Row className="g-md-4 g-sm-3 g-2 checkout-form">
        ...
        <SimpleInputField
          nameList={[
            { name: "billing_address.title", placeholder: t("enter_title"), toplabel: "Title", colprops: { md: 12 }, require: "true" },
        ...
        />
          ...
          <div className="form-box position-relative">
            <div className="country-input">
              <SimpleInputField nameList={[{ name: "billing_address?.phone", type: "number", placeholder: t("enter_phone"), require: "true", toplabel: "Phone", colprops: { xs: 12 }, colclass: "country-input-box" }]} />
              <SearchableSelectInput
                nameList={[
                  {
