      ...
      <Row className="checkout-form g-md-4 g-sm-3 g-2">
        <Col sm={6}>
          <div className="form-box">
            <SimpleInputField nameList={[{ name: "name", placeholder: t("enter_name"), toplabel: "FullName", require: "true" }]} />
          </div>
        </Col>
        <Col sm={6}>
          <div className="form-box">
            <SimpleInputField nameList={[{ name: "email", placeholder: t("enter_email_address"), toplabel: "Email", require: "true" }]} />
          </div>
        </Col>
        ...
        {values.create_account == true && (
          <Col md={6}>
            <div className="form-box">
              <SimpleInputField nameList={[{ name: "password", placeholder: t("enter_password"), type: "password", title: "password", toplabel: "Password", require: "true" }]} />
            </div>
          </Col>
        )}
      </Row>
