  ...
  return (
    <div className="checkbox-main-box">
      ...
      <Row className="checkout-form g-md-4 g-sm-3 g-2">
        ...
        <SimpleInputField
          nameList={[
            { name: "shipping_address.city", placeholder: t("enter_city"), toplabel: "City", colprops: { md: 6 }, require: "true" },
            { name: "shipping_address.pincode", placeholder: t("enter_pincode"), toplabel: "Pincode", colprops: { md: 6 }, require: "true" },
          ]}
        />
         <Col xs={12} className="phone-field">
          <div className="form-box position-relative">
            <div className="country-input">
              <SimpleInputField nameList={[{ name: "shipping_address.phone", type: "number", placeholder: t("enter_phone"), require: "true", toplabel: "Phone", colprops: { xs: 12 }, colclass: "country-input-box" }]} />
              <SearchableSelectInput
                nameList={[
                  {
