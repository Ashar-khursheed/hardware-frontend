...
export const horizontalProductSlider5 = (length) => {
  return {
    infinite: length > 1,
    swipeToSlide: true,
    slidesToShow: Math.min(6, length > 0 ? length : 6),
    slidesToScroll: 1,
    arrows: false,
    autoplay: length > 1,
    autoplaySpeed: 3000,
    responsive: [
      {
        breakpoint: 1400,
        settings: {
          slidesToShow: Math.min(5, length > 0 ? length : 5),
          infinite: length > 1,
          autoplay: length > 1,
        },
      },
      {
        breakpoint: 1200,
        settings: {
          slidesToShow: Math.min(4, length > 0 ? length : 4),
          infinite: length > 1,
        },
      },
      {
        breakpoint: 992,
        settings: {
          slidesToShow: Math.min(3, length > 0 ? length : 3),
          infinite: length > 1,
        },
      },
      {
