        ...
        <Container>
          <Row className="py-5 text-white g-4">
            ...
            <Col xs={12} md={6} lg={3}>
              ...
              <p className="small text-white mb-1">
                <a href="/category/power-supply--and-protection" className="text-white text-decoration-none">Power Supply</a>
              </p>
              <p className="small text-white mb-1">
            ...
            <Col xs={12} md={6} lg={3}>
              ...
              <div className="d-flex align-items-center">
                ...
                <a href="mailto:support@thehardwarebox.com" className="text-white text-decoration-none small">
                  support@thehardwarebox.com
                </a>
              </div>
            </Col>
            ...
            <Col md="4" className="text-center">
              <div className="d-flex flex-column flex-md-row justify-content-center gap-3">
                ...
                <div className="text-start">
                  ...
                  <span className="small text-white">5900 Balcones Drive # 22288 Austin, TX 78731</span>
                </div>
